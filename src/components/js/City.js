...
class City {
    constructor(name = null, latitude = 0, longitude = 0, population = 0) {
        this.name = name
    ...
    show() {
        return `${this.name} [${this.latitude}, ${this.longitude}] (pop. ${this.population.toLocaleString(undefined)})`
    }
